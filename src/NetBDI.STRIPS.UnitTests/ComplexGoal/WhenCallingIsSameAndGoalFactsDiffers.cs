...
{
    public class WhenCallingIsSameAndGoalFactsDiffers
    {
        ...
        public void Setup()
        {
            ...
            _subFact1.Setup(x => x.IsSameAs(It.IsAny<STRIPS.Fact>())).Returns(false);
            ...
            var subGoal2 = new STRIPS.SimpleGoal(_subFact1.Object);
        ...
        [Test]
        public void ThenIsSameAsIsCalledOnFactsUntilReturnsFalse()
        {
            _subFact1.Verify(x => x.IsSameAs(_subFact1.Object), Times.Once);
            _subFact2.Verify(x => x.IsSameAs(_subFact2.Object), Times.Never);
        }
    }
}